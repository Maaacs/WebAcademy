...
function confirmarCadastroBicicleta() {
    let modelo: string, fabricante: string, preco: number;
    let aro: number;
    let produto:Bicycle;

    modelo = (document.getElementById('modeloBicicleta') as HTMLInputElement).value;
    fabricante = (document.getElementById('fabricanteBicicleta') as HTMLInputElement).value;
    preco = parseFloat((document.getElementById('precoBicicleta') as HTMLInputElement).value);
    aro = parseInt((document.getElementById('aroBicicleta') as HTMLInputElement).value);
...
function confirmarCadastroCelular() {
    let modelo: string, fabricante: string, preco: number;
    let memoria: string;
    let produto: Cellphone;

    modelo = (document.getElementById('modeloCelular') as HTMLInputElement).value;
    fabricante = (document.getElementById('fabricanteCelular') as HTMLInputElement).value;
    preco = parseFloat((document.getElementById('precoCelular') as HTMLInputElement).value);
    memoria = (document.getElementById('memoriaCelular') as HTMLInputElement).value;
...
function confirmarCadastroTv() {
    ...
    let modelo: string, fabricante: string, preco: number;
    let resolucao: string, tamanho: number;
    let produto: TV;
    

    modelo = (document.getElementById('modeloTv') as HTMLInputElement).value;
    fabricante = (document.getElementById('fabricanteTv') as HTMLInputElement).value;
    preco = parseFloat((document.getElementById('precoTv') as HTMLInputElement).value);

    resolucao = (document.getElementById('resolucaoTv') as HTMLInputElement).value;
    
    tamanho = parseInt((document.getElementById('tamanhoTv') as HTMLInputElement).value);
...
(window as any).confirmarCadastroBicicleta = confirmarCadastroBicicleta;
(window as any).confirmarCadastroCelular = confirmarCadastroCelular;
(window as any).confirmarCadastroTv = confirmarCadastroTv;